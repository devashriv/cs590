...
var TransformControls = function ( camera, domElement ) {
	...
	defineproperty( "rotationYSnap", null); 															//new
	...
	this.pointerDown = function ( pointer ) {
		...
		if ( ( pointer.button === 0 || pointer.button === undefined ) && this.axis !== null ) {
			...
			if ( planeIntersect ) {
				...
				if ( space === 'local' && this.mode === 'rotateY' ) {

					var snap = this.rotationYSnap;
	...
	this.pointerMove = function ( pointer ) {
		...
		//new
			...
			if ( this.rotationYSnap ) rotationAngle = Math.round( rotationAngle / this.rotationYSnap ) * this.rotationYSnap;
	...
	this.setRotationYSnap = function ( rotationYSnap ) {

		scope.rotationYSnap = rotationYSnap;
...
var TransformControlsGizmo = function () {
	...
	this.add( this.gizmo[ "rotateY" ] = setupGizmo( gizmoRotateY ) );						//new
	...
	this.updateMatrixWorld = function () {
		...
		this.gizmo[ "rotateY" ].visible = this.mode === "rotateY";								//new
		this.gizmo[ "scale" ].visible = this.mode === "scale";

		this.helper[ "translate" ].visible = this.mode === "translate";
		this.helper[ "rotate" ].visible = this.mode === "rotate";
		this.helper[ "rotateY" ].visible = this.mode === "rotateY";								//new
